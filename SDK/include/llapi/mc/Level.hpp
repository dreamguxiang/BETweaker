...
public:
    ...
    MCVAPI void addBreakingItemParticleEffect(class Vec3 const &, enum ParticleType, struct ResolvedItemIconInfo const &);
    ...
    MCVAPI bool applyLiquidPhysicsToActor(class Actor *, enum MaterialType);
