...
public:
    ...
    /*204*/ virtual int getTurnOnDelay(class Block const &) const;
    /*205*/ virtual class Block const * getOnBlock(class Block const *) const;
    /*206*/ virtual class Block const * getOffBlock(class Block const *) const;
