...
#endif
    MCAPI CutCopperStairs(std::string const &, int, class BlockLegacy const &, enum CopperType, class HashedString const &);
    MCAPI CutCopperStairs(std::string const &, int, class BlockLegacy const &, enum CopperType, class HashedString const &, class HashedString const &, class HashedString const &);
