...
public:
    ...
    MCAPI void addCategory(enum ActorCategory const &);
    ...
    MCAPI enum ActorCategory getCategories() const;
    ...
    MCAPI static bool isInLiquid(enum MaterialType, class IConstBlockSource const &, class AABB const &, std::vector<class AABB> const &);
