...
public:
    ...
    MCVAPI void fireClubsEngagementEvent(enum IMinecraftEventing::ClubsEngagementAction, enum IMinecraftEventing::ClubsEngagementTargetType, char const *, struct Realms::RealmId, std::string const &);
    MCVAPI void fireClubsOpenFeedScreenEvent(enum IMinecraftEventing::ClubsFeedScreenSource, struct Realms::RealmId, std::string const &);
    MCVAPI void fireCodeCommandButtonPressed();
    MCVAPI void fireCommunitySIFTProcessEvent(std::string const &, enum TextProcessingEventOrigin, unsigned short, bool, double, char, char, class Json::Value const &);
    ...
    MCVAPI void fireEventScriptWatchdog(enum Scripting::WatchdogEventType, bool, unsigned __int64, float, int, unsigned __int64, struct Scripting::ModuleDescriptor const *, bool);
    ...
    MCVAPI void fireServerStarted(enum IMinecraftEventing::ServerType, std::string const &);
