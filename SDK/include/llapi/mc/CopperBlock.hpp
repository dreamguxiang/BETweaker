...
#endif
    MCAPI CopperBlock(std::string const &, int, enum CopperType, class HashedString const &);
    MCAPI CopperBlock(std::string const &, int, enum CopperType, class HashedString const &, class HashedString const &, class HashedString const &);
