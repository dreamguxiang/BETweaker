...
public:
    ...
    /*27*/ virtual short getMaxHeight() const;
    /*28*/ virtual short getMinHeight() const;
    /*29*/ virtual void __unk_vfn_29();
    /*30*/ virtual void __unk_vfn_30();
    /*31*/ virtual void __unk_vfn_31();
    /*32*/ virtual class LevelChunk * getChunkAt(class BlockPos const &) const;
    /*33*/ virtual class ILevel & getILevel() const;
    /*34*/ virtual class ChunkSource & getChunkSource();
    /*35*/ virtual bool isSolidBlockingBlock(class BlockPos const &) const;
...
//private:
    MCAPI void _addToTickingQueue(class BlockPos const &, class Block const &, int, int, enum TickingQueueType, bool);
