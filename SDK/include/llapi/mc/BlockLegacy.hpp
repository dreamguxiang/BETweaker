...
public:
    ...
    /*63*/ virtual class std::optional<class HashedString> getRequiredMedium() const;
    /*64*/ virtual bool shouldConnectToRedstone(class BlockSource &, class BlockPos const &, int) const;
    /*65*/ virtual void handlePrecipitation(class BlockSource &, class BlockPos const &, float, float) const;
    /*66*/ virtual bool canBeUsedInCommands(class BaseGameVersion const &) const;
    /*67*/ virtual float getThickness() const;
    /*68*/ virtual float getFlexibility(class BlockSource &, class BlockPos const &) const;
    /*69*/ virtual bool checkIsPathable(class Actor &, class BlockPos const &, class BlockPos const &) const;
    /*70*/ virtual bool shouldDispense(class BlockSource &, class Container &) const;
    /*71*/ virtual bool dispense(class BlockSource &, class Container &, int, class Vec3 const &, unsigned char) const;
    /*72*/ virtual void transformOnFall(class BlockSource &, class BlockPos const &, class Actor *, float) const;
    ...
    /*81*/ virtual void updateEntityAfterFallOn(class BlockPos const &, struct UpdateEntityAfterFallOnInterface &) const;
    ...
    /*85*/ virtual bool ignoreEntitiesOnPistonMove(class Block const &) const;
    ...
    /*104*/ virtual void trySpawnResourcesOnExplosion(class BlockSource &, class BlockPos const &, class Block const &, class Randomize &, std::vector<class Item const *> *, float) const;
    ...
    /*120*/ virtual void forceExecuteTrigger(class DefinitionTrigger const &, class RenderParams &) const;
    /*121*/ virtual class MobSpawnerData const * getMobToSpawn(class SpawnConditions const &, class BlockSource &) const;
    ...
    /*144*/ virtual class AABB const & getUIShape(class Block const &, class AABB &) const;
    /*145*/ virtual int telemetryVariant(class BlockSource &, class BlockPos const &) const;
    /*146*/ virtual int getVariant(class Block const &) const;
    /*147*/ virtual bool canSpawnOn(class Actor *) const;
    /*148*/ virtual class Block const & getRenderBlock() const;
    ...
    /*160*/ virtual class Block const * tryGetInfested(class Block const &) const;
    /*161*/ virtual class Block const * tryGetUninfested(class Block const &) const;
    ...
    /*175*/ virtual bool shouldRandomTick() const;
    ...
    /*182*/ virtual int getExtraRenderLayers() const;
    /*183*/ virtual float getExplosionResistance(class Actor *) const;
    /*184*/ virtual struct Brightness getEmissiveBrightness(class Block const &) const;
    /*185*/ virtual class mce::Color getMapColor() const;
    ...
    /*190*/ virtual void _executeEvent(std::string const &, std::vector<struct std::pair<std::string const, std::string const>> &, class RenderParams &) const;
    /*191*/ virtual bool _executeTrigger(class DefinitionTrigger const &, std::vector<struct std::pair<std::string const, std::string const>> &, class RenderParams &) const;
    /*192*/ virtual void _forceExecuteTrigger(class DefinitionTrigger const &, std::vector<struct std::pair<std::string const, std::string const>> &, class RenderParams &) const;
...
//protected:
    MCAPI enum BlockShape _getBlockShape() const;
