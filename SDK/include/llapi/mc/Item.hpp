...
public:
    ...
    /*108*/ virtual void setDamageValue(class ItemStackBase &, short) const;
    /*109*/ virtual enum InHandUpdateType getInHandUpdateType(class Player const &, class ItemInstance const &, class ItemInstance const &, bool, bool) const;
    /*110*/ virtual enum InHandUpdateType getInHandUpdateType(class Player const &, class ItemStack const &, class ItemStack const &, bool, bool) const;
    /*111*/ virtual bool validFishInteraction(int) const;
    /*112*/ virtual void enchantProjectile(class ItemStackBase const &, class Actor &) const;
    ...
    /*123*/ virtual int getIconYOffset() const;
