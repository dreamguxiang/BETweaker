...
#undef AFTER_EXTRA
    ...
    MCAPI std::unique_ptr<class Scripting::IRuntime> CreateRuntimeByType(enum ScriptRuntimeType, class Scripting::RegistryManager &, class Scripting::DependencyLocator *);
