...
public:
    ...
    /*194*/ virtual int getSignalStrength(class BlockSource &, class BlockPos const &) const;
    /*195*/ virtual int getSignalForData(int) const;
    /*196*/ virtual int getRedstoneSignal(int) const;
