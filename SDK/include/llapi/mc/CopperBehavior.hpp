...
#endif
    MCAPI CopperBehavior(enum CopperType, class HashedString const &, class std::function<class Block const & (class HashedString const &, class Block const &)> const &);
    MCAPI CopperBehavior(enum CopperType, class HashedString const &, class HashedString const &, class HashedString const &, class std::function<class Block const & (class HashedString const &, class Block const &)> const &);
