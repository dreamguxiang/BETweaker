...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_BALLOONDESCRIPTION
public:
    struct BalloonDescription& operator=(struct BalloonDescription const &) = delete;
    BalloonDescription(struct BalloonDescription const &) = delete;
    BalloonDescription() = delete;
#endif
public:
