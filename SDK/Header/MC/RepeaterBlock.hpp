...
public:
    ...
    /*213*/ virtual int getTurnOnDelay(class Block const &) const;
    /*214*/ virtual class Block const * getOnBlock(class Block const *) const;
    /*215*/ virtual class Block const * getOffBlock(class Block const *) const;
    /*
