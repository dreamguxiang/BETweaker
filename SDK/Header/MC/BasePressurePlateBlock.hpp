...
public:
    ...
    /*202*/ virtual int getTickDelay() const;
    /*203*/ virtual int getSignalStrength(class BlockSource &, class BlockPos const &) const = 0;
    /*204*/ virtual int getSignalForData(int) const = 0;
    /*205*/ virtual int getRedstoneSignal(int) const = 0;
    /*206*/ virtual class AABB const getSensitiveAABB(class BlockPos const &) const;
    /*
