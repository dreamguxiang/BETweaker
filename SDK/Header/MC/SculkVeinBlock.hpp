...
public:
    ...
    /*202*/ virtual class Block const & getMultifaceBlock() const;
    /*203*/ virtual class MultifaceSpreader const & getMultifaceSpreader() const;
    /*
    inline bool canBeSilkTouched() const{
        bool (SculkVeinBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canBeSilkTouched@SculkVeinBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    */
