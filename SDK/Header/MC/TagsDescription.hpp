...
struct TagsDescription {

#define AFTER_EXTRA

#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_TAGSDESCRIPTION
public:
    struct TagsDescription& operator=(struct TagsDescription const &) = delete;
    TagsDescription(struct TagsDescription const &) = delete;
    TagsDescription() = delete;
#endif
public:
    /*0*/ virtual char const * getNodeName();
    /*1*/ virtual char const * getJsonName() const;
    /*2*/ virtual char const * getDescription() const;
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_TAGSDESCRIPTION
