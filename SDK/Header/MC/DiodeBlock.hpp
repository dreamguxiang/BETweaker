...
public:
    ...
    /*202*/ virtual int getSignal(class BlockSource &, class BlockPos const &, int) const;
    /*203*/ virtual bool isLocked(class BlockSource &, class BlockPos const &) const;
    /*204*/ virtual bool isSameDiode(class Block const &) const;
    /*205*/ virtual bool shouldPrioritize(class BlockSource &, class BlockPos const &) const;
    /*206*/ virtual bool isOn() const;
    /*207*/ virtual bool shouldTurnOn(class BlockSource &, class BlockPos const &) const;
    /*208*/ virtual int getInputSignal(class BlockSource &, class BlockPos const &) const;
    /*209*/ virtual bool isAlternateInput(class Block const &) const;
    /*210*/ virtual int getAlternateSignal(class BlockSource &, class BlockPos const &) const;
    /*211*/ virtual int getOutputSignal(class Block const &) const;
    /*212*/ virtual int getTurnOffDelay(class Block const &) const;
    /*213*/ virtual int getTurnOnDelay(class Block const &) const = 0;
    /*214*/ virtual class Block const * getOnBlock(class Block const *) const = 0;
    /*215*/ virtual class Block const * getOffBlock(class Block const *) const = 0;
    /*
