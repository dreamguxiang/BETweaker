...
public:
    ...
    /*203*/ virtual int getSignalStrength(class BlockSource &, class BlockPos const &) const;
    /*204*/ virtual int getSignalForData(int) const;
    /*205*/ virtual int getRedstoneSignal(int) const;
