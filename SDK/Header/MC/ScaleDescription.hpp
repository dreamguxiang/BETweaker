...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCALEDESCRIPTION
public:
    struct ScaleDescription& operator=(struct ScaleDescription const &) = delete;
    ScaleDescription(struct ScaleDescription const &) = delete;
    ScaleDescription() = delete;
#endif
public:
