...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_HOMEDESCRIPTION
public:
    struct HomeDescription& operator=(struct HomeDescription const &) = delete;
    HomeDescription(struct HomeDescription const &) = delete;
...
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_HOMEDESCRIPTION
