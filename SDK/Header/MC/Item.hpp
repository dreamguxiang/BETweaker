...
public:
    ...
    /*5*/ virtual int getMaxUseDuration(class ItemInstance const *);
    /*6*/ virtual int getMaxUseDuration(class ItemStack const *);
    /*7*/ virtual void __unk_vfn_7();
    /*8*/ virtual bool hasTag(class HashedString const &) const;
    /*9*/ virtual bool hasTag(struct ItemTag const &) const;
    /*10*/ virtual void executeEvent(class ItemStackBase &, std::string const &, class RenderParams &);
    ...
    /*65*/ virtual int getArmorValue();
    /*66*/ virtual int getToughnessValue();
    /*67*/ virtual void __unk_vfn_67();
    /*68*/ virtual bool isValidAuxValue(int);
    /*69*/ virtual int getDamageChance(int) const;
    /*70*/ virtual float getViewDamping();
    /*71*/ virtual void __unk_vfn_71();
    /*72*/ virtual void __unk_vfn_72();
    /*73*/ virtual void __unk_vfn_73();
    /*74*/ virtual class mce::Color getColor(class CompoundTag const *, class ItemDescriptor const &);
    /*75*/ virtual bool hasCustomColor(class CompoundTag const *);
    /*76*/ virtual void __unk_vfn_76();
    /*77*/ virtual void clearColor(class ItemStackBase &);
    /*78*/ virtual void clearColor(class CompoundTag *);
    ...
    /*84*/ virtual bool canUseOnSimTick();
    ...
    /*89*/ virtual float getDestroySpeed(class ItemStackBase const &, class Block const &);
    /*90*/ virtual void hurtActor(class ItemStack &, class Actor &, class Mob &) const;
    /*91*/ virtual void hitActor(class ItemStack &, class Actor &, class Mob &);
    /*92*/ virtual void hitBlock(class ItemStack &, class Block const &, class BlockPos const &, class Mob &);
    /*93*/ virtual bool mineBlock(class ItemInstance &, class Block const &, int, int, int, class Actor *);
    ...
    /*102*/ virtual bool inventoryTick(class ItemStack &, class Level &, class Actor &, int, bool);
    /*103*/ virtual void refreshedInContainer(class ItemStackBase const &, class Level &);
    ...
    /*111*/ virtual enum InHandUpdateType getInHandUpdateType(class Player const &, class ItemInstance const &, class ItemInstance const &, bool, bool);
    /*112*/ virtual enum InHandUpdateType getInHandUpdateType(class Player const &, class ItemStack const &, class ItemStack const &, bool, bool);
    /*113*/ virtual bool validFishInteraction(int);
    /*114*/ virtual void enchantProjectile(class ItemStackBase const &, class Actor &);
    ...
    /*124*/ virtual int getIconYOffset();
    ...
    /*129*/ virtual void playSoundIncrementally(class ItemStack const &, class Mob &);
    ...
    /*135*/ virtual bool _calculatePlacePos(class ItemStackBase &, class Actor &, unsigned char &, class BlockPos &);
