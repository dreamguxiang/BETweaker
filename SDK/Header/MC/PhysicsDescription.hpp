...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_PHYSICSDESCRIPTION
public:
    struct PhysicsDescription& operator=(struct PhysicsDescription const &) = delete;
    PhysicsDescription(struct PhysicsDescription const &) = delete;
    PhysicsDescription() = delete;
#endif
public:
