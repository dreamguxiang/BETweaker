...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_ISCHESTEDDESCRIPTION
public:
    struct IsChestedDescription& operator=(struct IsChestedDescription const &) = delete;
    IsChestedDescription(struct IsChestedDescription const &) = delete;
    IsChestedDescription() = delete;
#endif
public:
    /*0*/ virtual char const * getNodeName();
    /*1*/ virtual char const * getJsonName() const;
    /*2*/ virtual char const * getDescription() const;
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_ISCHESTEDDESCRIPTION
