...
public:
    ...
    /*202*/ virtual class mce::Color getDustColor(class Block const &) const;
    /*203*/ virtual std::string getDustParticleName(class Block const &) const;
    /*204*/ virtual void __unk_vfn_204();
    /*205*/ virtual void onLand(class BlockSource &, class BlockPos const &) const;
    /*206*/ virtual bool isFreeToFall(class BlockSource &, class BlockPos const &) const;
    /*207*/ virtual void startFalling(class BlockSource &, class BlockPos const &, class Block const &, bool) const;
    /*
