...
{
    Item = 0x40,                     // minecraft:item,                   ∑≠“Î: ŒÔ∆∑
    Tnt = 0x41,                      // minecraft:tnt,                    ∑≠“Î: TNT ∑ΩøÈ
    FallingBlock = 0x42,             // minecraft:falling_block,          ∑≠“Î: œ¬¬‰µƒ∑ΩøÈ
    MovingBlock = 0x43,              // minecraft:moving_block,           ∑≠“Î: “∆∂Ø÷–µƒ∑ΩøÈ
    XpOrb = 0x45,                    // minecraft:xp_orb,                 ∑≠“Î: æ≠—È«Ú
    EyeOfEnderSignal = 0x46,         // minecraft:eye_of_ender_signal,    ∑≠“Î: ƒ©”∞÷Æ—€
    EnderCrystal = 0x47,             // minecraft:ender_crystal,          ∑≠“Î: ƒ©”∞ÀÆæß
    FireworksRocket = 0x48,          // minecraft:fireworks_rocket,       ∑≠“Î: —Êªªº˝
    FishingHook = 0x4D,              // minecraft:fishing_hook,           ∑≠“Î: ”„π≥
    Chalkboard = 0x4E,               // minecraft:chalkboard,             ∑≠“Î: entity.chalkboard.name
    Painting = 0x53,                 // minecraft:painting,               ∑≠“Î: ª≠
    LeashKnot = 0x58,                // minecraft:leash_knot,             ∑≠“Î: À©…˛Ω·
    Boat = 0x5A,                     // minecraft:boat,                   ∑≠“Î: ¥¨
    LightningBolt = 0x5D,            // minecraft:lightning_bolt,         ∑≠“Î: …¡µÁ
    AreaEffectCloud = 0x5F,          // minecraft:area_effect_cloud,      ∑≠“Î: «¯”Ú–ßπ˚‘∆ŒÌ
    Balloon = 0x6B,                  // minecraft:balloon,                ∑≠“Î: entity.balloon.name
    Shield = 0x75,                   // minecraft:shield,                 ∑≠“Î: entity.shield.name
    Npc = 0x0133,                    // minecraft:npc,                    ∑≠“Î: entity.npc.name
    Agent = 0x0138,                  // minecraft:agent,                  ∑≠“Î: entity.agent.name
    ArmorStand = 0x013D,             // minecraft:armor_stand,            ∑≠“Î: ø¯º◊º‹
    TripodCamera = 0x013E,           // minecraft:tripod_camera,          ∑≠“Î: »˝Ω≈º‹…„œÒª˙
    Player = 0x013F,                 // minecraft:player,                 ∑≠“Î: entity.player.name
    Bee = 0x017A,                    // minecraft:bee,                    ∑≠“Î: √€∑‰
    Piglin = 0x017B,                 // minecraft:piglin,                 ∑≠“Î: ÷Ì¡È
    PiglinBrute = 0x017F,            // minecraft:piglin_brute,           ∑≠“Î: ≤–±©÷Ì¡È
    IronGolem = 0x0314,              // minecraft:iron_golem,             ∑≠“Î: Ã˙ø˛¿‹
    SnowGolem = 0x0315,              // minecraft:snow_golem,             ∑≠“Î: —©ø˛¿‹
    WanderingTrader = 0x0376,        // minecraft:wandering_trader,       ∑≠“Î: ¡˜¿À…Ã»À
    Creeper = 0x0B21,                // minecraft:creeper,                ∑≠“Î: ≈¿––’ﬂ
    Slime = 0x0B25,                  // minecraft:slime,                  ∑≠“Î:  ∑¿≥ƒ∑
    Enderman = 0x0B26,               // minecraft:enderman,               ∑≠“Î: ƒ©”∞»À
    Ghast = 0x0B29,                  // minecraft:ghast,                  ∑≠“Î: ∂ÒªÍ
    MagmaCube = 0x0B2A,              // minecraft:magma_cube,             ∑≠“Î: —“Ω¨π÷
    Blaze = 0x0B2B,                  // minecraft:blaze,                  ∑≠“Î: ¡“—Ê»À
    Witch = 0x0B2D,                  // minecraft:witch,                  ∑≠“Î: ≈ÆŒ◊
    Guardian = 0x0B31,               // minecraft:guardian,               ∑≠“Î:  ÿŒ¿’ﬂ
    ElderGuardian = 0x0B32,          // minecraft:elder_guardian,         ∑≠“Î: ‘∂π≈ ÿŒ¿’ﬂ
    EnderDragon = 0x0B35,            // minecraft:ender_dragon,           ∑≠“Î: ƒ©”∞¡˙
    Shulker = 0x0B36,                // minecraft:shulker,                ∑≠“Î: «±”∞±¥
    Vindicator = 0x0B39,             // minecraft:vindicator,             ∑≠“Î: Œ¿µ¿ ø
    Ravager = 0x0B3B,                // minecraft:ravager,                ∑≠“Î: ΩŸ¬” ﬁ
    EvocationIllager = 0x0B68,       // minecraft:evocation_illager,      ∑≠“Î: ªΩƒß’ﬂ
    Vex = 0x0B69,                    // minecraft:vex,                    ∑≠“Î: ƒ’πÌ
    Pillager = 0x0B72,               // minecraft:pillager,               ∑≠“Î: ¬”∂·’ﬂ
    ElderGuardianGhost = 0x0B78,     // minecraft:elder_guardian_ghost,   ∑≠“Î: entity.elder_guardian_ghost.name
    Chicken = 0x130A,                // minecraft:chicken,                ∑≠“Î: º¶
    Cow = 0x130B,                    // minecraft:cow,                    ∑≠“Î: ≈£
    Pig = 0x130C,                    // minecraft:pig,                    ∑≠“Î: ÷Ì
    Sheep = 0x130D,                  // minecraft:sheep,                  ∑≠“Î: —Ú
    Mooshroom = 0x1310,              // minecraft:mooshroom,              ∑≠“Î: ﬂËπΩ
    Rabbit = 0x1312,                 // minecraft:rabbit,                 ∑≠“Î: Õ√◊”
    PolarBear = 0x131C,              // minecraft:polar_bear,             ∑≠“Î: ±±º´–‹
    Llama = 0x131D,                  // minecraft:llama,                  ∑≠“Î: —ÚÕ’
    Turtle = 0x134A,                 // minecraft:turtle,                 ∑≠“Î: ∫£πÍ
    Panda = 0x1371,                  // minecraft:panda,                  ∑≠“Î: –‹√®
    Fox = 0x1379,                    // minecraft:fox,                    ∑≠“Î: ∫¸¿Í
    Hoglin = 0x137C,                 // minecraft:hoglin,                 ∑≠“Î: ‡÷Ì ﬁ
    Strider = 0x137D,                // minecraft:strider,                ∑≠“Î: ≥„◊„ ﬁ
    Goat = 0x1380,                   // minecraft:goat,                   ∑≠“Î: …Ω—Ú
    Axolotl = 0x1382,                // minecraft:axolotl,                ∑≠“Î: √¿Œ˜Û¢
    Squid = 0x2311,                  // minecraft:squid,                  ∑≠“Î: ˆœ”„
    Dolphin = 0x231F,                // minecraft:dolphin,                ∑≠“Î: ∫£Î‡
    Pufferfish = 0x236C,             // minecraft:pufferfish,             ∑≠“Î: ∫”Î‡
    Salmon = 0x236D,                 // minecraft:salmon,                 ∑≠“Î: ˆŸ”„
    Tropicalfish = 0x236F,           // minecraft:tropicalfish,           ∑≠“Î: »»¥¯”„
    Cod = 0x2370,                    // minecraft:cod,                    ∑≠“Î: ˜®”„
    GlowSquid = 0x2381,              // minecraft:glow_squid,             ∑≠“Î: ∑¢π‚ˆœ”„
    Wolf = 0x530E,                   // minecraft:wolf,                   ∑≠“Î: ¿«
    Ocelot = 0x5316,                 // minecraft:ocelot,                 ∑≠“Î: ±™√®
    Parrot = 0x531E,                 // minecraft:parrot,                 ∑≠“Î: –ƒ
    Cat = 0x534B,                    // minecraft:cat,                    ∑≠“Î: √®
    Bat = 0x8113,                    // minecraft:bat,                    ∑≠“Î: Ú˘Ú
    ZombiePigman = 0x010B24,         // minecraft:zombie_pigman,          ∑≠“Î: Ω© ¨÷Ì¡È
    Wither = 0x010B34,               // minecraft:wither,                 ∑≠“Î: µÚ¡È
    Phantom = 0x010B3A,              // minecraft:phantom,                ∑≠“Î: ª√“Ì
    Zoglin = 0x010B7E,               // minecraft:zoglin,                 ∑≠“Î: Ω© ¨‡÷Ì ﬁ
    Zombie = 0x030B20,               // minecraft:zombie,                 ∑≠“Î: Ω© ¨
    ZombieVillager = 0x030B2C,       // minecraft:zombie_villager,        ∑≠“Î: Ω© ¨¥Â√Ò
    Husk = 0x030B2F,                 // minecraft:husk,                   ∑≠“Î:  ¨ø«
    Drowned = 0x030B6E,              // minecraft:drowned,                ∑≠“Î: ƒÁ ¨
    ZombieVillagerV2 = 0x030B74,     // minecraft:zombie_villager_v2,     ∑≠“Î: π÷»À¥Â√Ò
    Spider = 0x040B23,               // minecraft:spider,                 ∑≠“Î: ÷©÷Î
    Silverfish = 0x040B27,           // minecraft:silverfish,             ∑≠“Î: Ûº≥Ê
    CaveSpider = 0x040B28,           // minecraft:cave_spider,            ∑≠“Î: ∂¥—®÷©÷Î
    Endermite = 0x040B37,            // minecraft:endermite,              ∑≠“Î: ƒ©”∞Ú˝
    Minecart = 0x080054,             // minecraft:minecart,               ∑≠“Î: øÛ≥µ
    HopperMinecart = 0x080060,       // minecraft:hopper_minecart,        ∑≠“Î: ¬©∂∑øÛ≥µ
    TntMinecart = 0x080061,          // minecraft:tnt_minecart,           ∑≠“Î: TNT øÛ≥µ
    ChestMinecart = 0x080062,        // minecraft:chest_minecart,         ∑≠“Î: ‘À ‰øÛ≥µ
    CommandBlockMinecart = 0x080064, // minecraft:command_block_minecart, ∑≠“Î: √¸¡Ó∑ΩøÈøÛ≥µ
    Skeleton = 0x110B22,             // minecraft:skeleton,               ∑≠“Î: ˜º˜√
    Stray = 0x110B2E,                // minecraft:stray,                  ∑≠“Î: ¡˜¿À’ﬂ
    WitherSkeleton = 0x110B30,       // minecraft:wither_skeleton,        ∑≠“Î: µÚ¡È˜º˜√
    Horse = 0x205317,                // minecraft:horse,                  ∑≠“Î: ¬Ì
    Donkey = 0x205318,               // minecraft:donkey,                 ∑≠“Î: ¬ø
    Mule = 0x205319,                 // minecraft:mule,                   ∑≠“Î: ¬‚◊”
    SkeletonHorse = 0x215B1A,        // minecraft:skeleton_horse,         ∑≠“Î: ˜º˜√¬Ì
    ZombieHorse = 0x215B1B,          // minecraft:zombie_horse,           ∑≠“Î: Ω© ¨¬Ì
    XpBottle = 0x400044,             // minecraft:xp_bottle,              ∑≠“Î: ∏Ωƒß÷Æ∆ø
    ShulkerBullet = 0x40004C,        // minecraft:shulker_bullet,         ∑≠“Î: «±”∞±¥◊”µØ
    DragonFireball = 0x40004F,       // minecraft:dragon_fireball,        ∑≠“Î: ƒ©”∞¡˙ª«Ú
    Snowball = 0x400051,             // minecraft:snowball,               ∑≠“Î: —©«Ú
    Egg = 0x400052,                  // minecraft:egg,                    ∑≠“Î: º¶µ∞
    Fireball = 0x400055,             // minecraft:fireball,               ∑≠“Î: ª«Ú
    SplashPotion = 0x400056,         // minecraft:splash_potion,          ∑≠“Î: “©ÀÆ
    EnderPearl = 0x400057,           // minecraft:ender_pearl,            ∑≠“Î: ƒ©”∞’‰÷È
    WitherSkull = 0x400059,          // minecraft:wither_skull,           ∑≠“Î: µÚ¡ÈÕ∑¬≠
    WitherSkullDangerous = 0x40005B, // minecraft:wither_skull_dangerous, ∑≠“Î: µÚ¡ÈÕ∑¬≠
    SmallFireball = 0x40005E,        // minecraft:small_fireball,         ∑≠“Î: –°ª«Ú
    LingeringPotion = 0x400065,      // minecraft:lingering_potion,       ∑≠“Î: ÷Õ¡Ù“©ÀÆ
    LlamaSpit = 0x400066,            // minecraft:llama_spit,             ∑≠“Î: —ÚÕ’ø⁄ÀÆ
    EvocationFang = 0x400067,        // minecraft:evocation_fang,         ∑≠“Î: ªΩƒß’ﬂº‚—¿
    IceBomb = 0x40006A,              // minecraft:ice_bomb,               ∑≠“Î: entity.ice_bomb.name
    ThrownTrident = 0xC00049,        // minecraft:thrown_trident,         ∑≠“Î: »˝≤ÊÍ™
    Arrow = 0xC00050,                // minecraft:arrow,                  ∑≠“Î: º˝
    Villager = 0x0100030F,           // minecraft:villager,               ∑≠“Î: ¥Â√Ò
    VillagerV2 = 0x01000373,         // minecraft:villager_v2,            ∑≠“Î: ¥Â√Ò
};
