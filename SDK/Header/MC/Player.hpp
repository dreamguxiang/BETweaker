...
public:
    ...
    /*217*/ virtual bool canObstructSpawningAndBlockPlacement();
    ...
    /*265*/ virtual bool _shouldProvideFeedbackOnHandContainerItemSet(enum HandSlot, class ItemStack const &);
    ...
    /*412*/ virtual bool isLoading();
    /*413*/ virtual bool isPlayerInitialized();
    ...
    /*440*/ virtual void sendInventoryTransaction(class InventoryTransaction const &);
    /*441*/ virtual void sendComplexInventoryTransaction(std::unique_ptr<class ComplexInventoryTransaction>);
    /*442*/ virtual void sendNetworkPacket(class Packet &);
    /*443*/ virtual class PlayerEventCoordinator & getPlayerEventCoordinator();
    /*444*/ virtual class MoveInputHandler * tryGetMoveInputHandler();
    /*445*/ virtual enum InputMode getInputMode();
    /*446*/ virtual enum ClientPlayMode getPlayMode();
