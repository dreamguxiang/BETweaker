...
public:
    ...
    */
    ...
    MCAPI class Scripting::Result<void> teleport(class Vec3 const &, class ScriptDimension &, float, float, bool);
    MCAPI class Scripting::Result<void> teleportFacing(class Vec3 const &, class ScriptDimension &, class Vec3 const &, bool);
