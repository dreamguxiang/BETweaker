...
public:
    ...
    MCAPI static struct TickingSystemWithInfo createMigrator(class std::variant<struct SideBySideExtractionId::TickBegin, struct SideBySideExtractionId::EntityInside>);
