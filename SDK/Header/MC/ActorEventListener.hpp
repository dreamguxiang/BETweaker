...
public:
    ...
    inline enum EventResult onActorDefinitionEvent(class Actor & a0, std::string const & a1, std::vector<struct ActorDefinitionModifier> & a2){
        enum EventResult (ActorEventListener::*rv)(class Actor &, std::string const &, std::vector<struct ActorDefinitionModifier> &);
        *((void**)&rv) = dlsym("?onActorDefinitionEvent@ActorEventListener@@UEAA?AW4EventResult@@AEAVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAV?$vector@UActorDefinitionModifier@@V?$allocator@UActorDefinitionModifier@@@std@@@5@@Z");
        return (this->*rv)(std::forward<class Actor &>(a0), std::forward<std::string const &>(a1), std::forward<std::vector<struct ActorDefinitionModifier> &>(a2));
    }
