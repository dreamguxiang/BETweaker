...
public:
    ...
    /*203*/ virtual class ItemInstance const getBaseSeed() const;
    /*204*/ virtual class ItemInstance const getBaseCrop() const;
    /*205*/ virtual int getSeedNum(class Randomize &, int, int) const;
    /*206*/ virtual int getCropNum(class Randomize &, int, int) const;
    /*
