...
public:
    ...
    /*153*/ virtual class BlockLegacy & setLightBlock(struct Brightness);
    /*154*/ virtual class BlockLegacy & setLightEmission(struct Brightness);
    /*155*/ virtual class BlockLegacy & setExplodeable(float);
    /*156*/ virtual class BlockLegacy & setFlammable(class FlameOdds, class BurnOdds);
    /*157*/ virtual class BlockLegacy & setDestroyTime(float);
    /*158*/ virtual class BlockLegacy & setFriction(float);
    /*159*/ virtual class BlockLegacy & addState(class ItemState const &);
    /*160*/ virtual class BlockLegacy & addState(class ItemState const &, unsigned __int64);
    /*161*/ virtual class BlockLegacy & setAllowsRunes(bool);
    /*162*/ virtual class BlockLegacy & setCanBeOriginalSurface(bool);
    /*163*/ virtual class BlockLegacy & setMapColor(class mce::Color const &);
    /*164*/ virtual void __unk_vfn_164();
    /*165*/ virtual class ItemInstance getSilkTouchItemInstance(class Block const &) const;
    /*166*/ virtual void setVisualShape(class AABB const &);
    /*167*/ virtual void setVisualShape(class Vec3 const &, class Vec3 const &);
    ...
    /*173*/ virtual std::string _getHardCodedJSON() const;
    ...
    /*181*/ virtual void onFallOn(class BlockSource &, class BlockPos const &, class Actor &, float) const;
    /*182*/ virtual void playerDestroy(class Player &, class BlockPos const &, class Block const &) const;
    ...
    /*185*/ virtual bool shouldRandomTick() const;
    /*186*/ virtual void __unk_vfn_186();
    /*187*/ virtual class HitResult clip(class BlockSource const &, class BlockPos const &, class Vec3 const &, class Vec3 const &, bool) const;
    ...
    /*193*/ virtual float getExplosionResistance(class Actor *) const;
    /*194*/ virtual struct Brightness getLightEmission(class Block const &) const;
    /*195*/ virtual struct Brightness getEmissiveBrightness(class Block const &) const;
    ...
    /*199*/ virtual void _executeEvent(std::string const &, std::vector<struct std::pair<std::string const, std::string const>> &, class RenderParams &) const;
    /*200*/ virtual bool _executeTrigger(class DefinitionTrigger const &, std::vector<struct std::pair<std::string const, std::string const>> &, class RenderParams &) const;
    /*201*/ virtual void _forceExecuteTrigger(class DefinitionTrigger const &, std::vector<struct std::pair<std::string const, std::string const>> &, class RenderParams &) const;
    /*
    ...
    inline bool canOccludeVibrations() const{
        bool (BlockLegacy::*rv)() const;
        *((void**)&rv) = dlsym("?canOccludeVibrations@BlockLegacy@@UEBA_NXZ");
        return (this->*rv)();
    }
    ...
    inline bool canDamperVibrations() const{
        bool (BlockLegacy::*rv)() const;
        *((void**)&rv) = dlsym("?canDamperVibrations@BlockLegacy@@UEBA_NXZ");
        return (this->*rv)();
    }
...
private:
    ...
    MCAPI std::string makeInvalidStateMessage(class ItemState const &) const;
